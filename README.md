...
~~~~sql
select s1.halt_lang,
	min(case when s1.fahrt_id = 39362 then s1.abfahrtszeit end) fahrt_1,
	min(case when s1.fahrt_id = 39364 then s1.abfahrtszeit end) fahrt_2,
	min(case when s1.fahrt_id = 39366 then s1.abfahrtszeit end) fahrt_3
from 
(select  
    h.halt_lang,
    fsi.fahrt_id,
